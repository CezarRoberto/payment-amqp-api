...
export class MyLoggerService extends ConsoleLogger {
  ...
  error<Payload>(message: any, ...optionalParams: [...any, string?, string?]): void {
  ...
  warn<Payload>(message: any, ...optionalParams: [...any, string?, string?]): void {
  ...
  debug<Payload>(message: any, ...optionalParams: [...any, string?, string?]): void {
